...
using Zinlo.EntityFrameworkCore.Repositories;

namespace Zinlo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : ZinloRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<ZinloDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
