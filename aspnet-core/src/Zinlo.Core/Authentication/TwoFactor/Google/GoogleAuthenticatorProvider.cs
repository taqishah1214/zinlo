...
namespace Zinlo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ZinloServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Zinlo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
