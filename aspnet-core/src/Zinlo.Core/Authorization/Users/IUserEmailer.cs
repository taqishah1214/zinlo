...
namespace Zinlo.Authorization.Users
{
    public interface IUserEmailer
    {
        ...
        Task SendInviteUserEmail(string email,int tenantId, string link=null);
        Task SendCustomPlaEmail(string email, string price, string link, int tenantId, int editionId, int subscriptionStartType, int editionPaymentType,int commitment);
