...
{
    public class SessionAppService : ZinloAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = ZinloConsts.Currency,
                    CurrencySign = ZinloConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = ZinloConsts.AllowTenantsToChangeEmailSettings
                }
            };
