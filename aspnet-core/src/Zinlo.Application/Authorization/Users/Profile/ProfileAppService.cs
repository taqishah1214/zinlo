...
using Zinlo.Authentication.TwoFactor.Google;
using Zinlo.Authorization.Users.Dto;
using Zinlo.Authorization.Users.Profile.Cache;
using Zinlo.Authorization.Users.Profile.Dto;
using Zinlo.Friendships;
using Zinlo.Gdpr;
using Zinlo.Identity;
using Zinlo.Net.Sms;
using Zinlo.Security;
using Zinlo.Storage;
using Zinlo.Timing;

namespace Zinlo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : ZinloAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Zinlo",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Zinlo",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
