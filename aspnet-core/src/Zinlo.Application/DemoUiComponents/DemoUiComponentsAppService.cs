...
using Zinlo.DemoUiComponents.Dto;

namespace Zinlo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : ZinloAppServiceBase, IDemoUiComponentsAppService
    {
