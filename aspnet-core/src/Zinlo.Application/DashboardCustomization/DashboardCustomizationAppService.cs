...
using Zinlo.DashboardCustomization.Definitions;
using Zinlo.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Zinlo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : ZinloAppServiceBase, IDashboardCustomizationAppService
    {
