...
namespace Zinlo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ZinloAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ZinloDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(ZinloConsts.ConnectionStringName).Value.ToString();
        }
