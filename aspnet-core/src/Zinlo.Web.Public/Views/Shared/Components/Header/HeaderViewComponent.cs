...
using Zinlo.Url;
using Zinlo.Web.Public.Startup;
using Zinlo.Web.Session;

namespace Zinlo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ZinloViewComponent
    {
