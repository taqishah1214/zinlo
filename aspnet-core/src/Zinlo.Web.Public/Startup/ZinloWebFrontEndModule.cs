...
namespace Zinlo.Web.Public.Startup
{
    [DependsOn(
        typeof(ZinloWebCoreModule)
    )]
    public class ZinloWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public ZinloWebFrontEndModule(IWebHostEnvironment env, ZinloEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ZinloWebFrontEndModule).GetAssembly());
        }
    }
}
