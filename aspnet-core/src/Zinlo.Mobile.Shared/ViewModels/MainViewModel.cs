...
using Zinlo.Services.Navigation;
...
using Zinlo.ApiClient;
using Zinlo.Controls;
using Zinlo.Dto;
using Zinlo.Extensions;
using Zinlo.Localization;
using Zinlo.UI;
using Zinlo.UI.Assets;
using Zinlo.Views;
using DependencyResolver = Zinlo.Core.Dependency.DependencyResolver;
...
namespace Zinlo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Zinlo";
