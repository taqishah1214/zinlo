...
using Zinlo.Startup;
using Zinlo.Web.Authentication.JwtBearer;
using Zinlo.Web.Authentication.TwoFactor;
using Zinlo.Web.Chat.SignalR;
using Zinlo.Web.Configuration;
using Zinlo.Web.DashboardCustomization;
...
namespace Zinlo.Web
{
    ...
    public class ZinloWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ZinloWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(ZinloApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ZinloWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(ZinloWebCoreModule).Assembly);
        }
