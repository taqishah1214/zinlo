...
namespace Zinlo.Web.DashboardCustomization
{
    public class DashboardViewConfiguration
    {
        ...
        public DashboardViewConfiguration()
        {
            ...
            WidgetFilterViewDefinitions.Add(ZinloDashboardCustomizationConsts.Filters.FilterDateRangePicker,
            ...
            WidgetViewDefinitions.Add(ZinloDashboardCustomizationConsts.Widgets.Tenant.DailySales,
            ...
            WidgetViewDefinitions.Add(ZinloDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ZinloDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ZinloDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ZinloDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ZinloDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ZinloDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ZinloDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ZinloDashboardCustomizationConsts.Widgets.Host.TopStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ZinloDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ZinloDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ZinloDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                new WidgetViewDefinition(
