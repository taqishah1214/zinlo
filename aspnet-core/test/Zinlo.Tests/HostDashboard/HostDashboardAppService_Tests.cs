...
using Zinlo.MultiTenancy.HostDashboard;
...
namespace Zinlo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ZinloDbContext context, SubscriptionPayment subscriptionPayment)
        {
