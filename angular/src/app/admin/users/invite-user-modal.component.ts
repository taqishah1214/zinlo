...
import { CreateOrUpdateUserInput, OrganizationUnitDto, PasswordComplexitySetting, ProfileServiceProxy, UserEditDto, UserRoleDto, UserServiceProxy, InviteUserServiceServiceProxy, CreateOrUpdateInviteUser } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'inviteUserModalComponent',
...
export class InviteUserModalComponent extends AppComponentBase {
    ...
    user: CreateOrUpdateInviteUser = new CreateOrUpdateInviteUser();
    roles: UserRoleDto[];
    ...
    save(): void {
        let input = new CreateOrUpdateInviteUser();
        ...
        var roles =
            ...
            roles.forEach(element => {
                ...
                {
                input.roleId = input.roleId +","+element;
                }else{
                    input.roleId = input.roleId +""+element;
                }
            });
        ...
        this.saving = true;
        this._inviteUserService.create(input)
