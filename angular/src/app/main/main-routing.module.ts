        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'reconcilliation/itemized/create-edit-itemized', component: CreateEditItemizedComponent, data: { permission: 'Pages.Reconciliation.Create' }},
                    { path: 'reconcilliation/amortized/create-edit-amortized', component: CreateEditAmortizedComponent, data: { permission: 'Pages.Reconciliation.Create' }},
                    { path: 'reconcilliation/itemized', component: ItemizedComponent, data: { permission: 'Pages.Reconciliation' }},
                    { path: 'reconcilliation/amortized', component: AmortizedComponent, data: { permission: 'Pages.Reconciliation' }},
                    { path: 'reconcilliation/itemized/itemized-details', component: ItemizedDetailsComponent, data: { permission: 'Pages.Reconciliation' }},
                    { path: 'reconcilliation/amortized/amortized-details', component: AmortizedDetailsComponent, data: { permission: 'Pages.Reconciliation' }},
