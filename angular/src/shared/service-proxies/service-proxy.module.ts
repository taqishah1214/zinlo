...
@NgModule({
    providers: [
        ApiServiceProxies.TimeManagementsServiceProxy,        
        ...
        ApiServiceProxies.UserRegisterServiceServiceProxy,
        ApiServiceProxies.ContactusServiceServiceProxy,
        ...
        ApiServiceProxies.InviteUserServiceServiceProxy,
        ...
        ApiServiceProxies.ChartsofAccountServiceProxy,
        ApiServiceProxies.AmortizationServiceProxy,
